    ...
    return (
        <div className="flex flex-col justify-center items-center dark:text-white">
            ...
            <div className="text-3xl my-2 flex">
                ...
                <a href="https://twitter.com/sdutttttt" target="_blank" rel="noreferrer"><RiTwitterXLine className="mx-2 hover:text-black" /></a>
            ...
            <p className="my-3 text-center font-nav text-xs text-gray-700 dark:text-gray-300">Created by me <a href="https://twitter.com/sdutttttt" target="_blank" rel="noreferrer">© Subham Dutta</a>, {new Date().getFullYear()}</p>
        </div>
    )
}
